const translations = {
  en: {
    ...
    // The Lord's Journey (Roadmap)
    journeyTag: "The Lord's Journey",
    journeyTitle1: "A Structured Path to",
    journeyTitle2: "Elite Funded Status",
    journeySubtitle: "A structured path from challenge to elite funded status.",
    journeyStep1Tag: "STEP 01", journeyStep1Title: "Accept The Challenge", journeyStep1Desc: "Pass the evaluation while respecting all risk rules.",
    journeyStep2Tag: "STEP 02", journeyStep2Title: "Earn Your Crown", journeyStep2Desc: "Complete verification and prove trading consistency.",
    journeyStep3Tag: "STEP 03", journeyStep3Title: "Become Funded", journeyStep3Desc: "Receive a funded account and earn up to 90% profit split.",
    journeyStep4Tag: "STEP 04", journeyStep4Title: "Rule The Capital", journeyStep4Desc: "Scale your account from $10K to $2M through the growth plan.",
    ...
    viewAll: 'View All', viewAllFAQs: 'View All FAQs', learnMore: 'Learn More', seeRoadmap: 'See Roadmap', contactSupport: 'Contact Support',
    ...
    // Live Payouts
    payoutTitle1: 'Payouts Made Simple,', payoutTitle2: 'Secure, and Seamless',
    payoutDesc: 'Lord Funded gives you complete transparency with real-time payout data — whether through Payout Junction or Blockchain, ensuring speed, trust, and global accessibility.',
    payoutCTA: 'Get Funded',
    payoutProcessed: 'Processed in',
    payoutMinutes: 'Mins',
    payoutHours: 'Hrs',
    payoutViewDetails: 'View Details',
  },
  ...
  es: {
    ...
    // El Viaje del Lord
    journeyTag: "El Viaje del Lord",
    journeyTitle1: "Un Camino Estructurado Hacia el",
    journeyTitle2: "Estado Financiado de Élite",
    journeySubtitle: "Un camino estructurado desde el desafío hasta el estado financiado de élite.",
    journeyStep1Tag: "PASO 01", journeyStep1Title: "Acepta el Desafío", journeyStep1Desc: "Supera la evaluación respetando todas las reglas de riesgo.",
    journeyStep2Tag: "PASO 02", journeyStep2Title: "Gana tu Corona", journeyStep2Desc: "Completa la verificación y demuestra consistencia en el trading.",
    journeyStep3Tag: "PASO 03", journeyStep3Title: "Consigue Financiamiento", journeyStep3Desc: "Recibe una cuenta financiada y gana hasta un 90% de participación en las ganancias.",
    journeyStep4Tag: "PASO 04", journeyStep4Title: "Domina el Capital", journeyStep4Desc: "Escala tu cuenta de $10K a $2M a través del plan de crecimiento.",
    ...
    viewAll: 'Ver Todo', viewAllFAQs: 'Ver todas las preguntas', learnMore: 'Saber Más', seeRoadmap: 'Ver Hoja de Ruta', contactSupport: 'Contactar Soporte',
    searchQuestions: 'Buscar preguntas...', questionsFound: 'preguntas encontradas',
    stillHaveQuestions: '¿Aún Tienes', supportAvailable: 'Nuestro equipo de soporte está disponible 24/7 to ayudarte.',
    ...
    // Live Payouts
    payoutTitle1: 'Pagos Hechos Simples,', payoutTitle2: 'Seguros y Perfectos',
    payoutDesc: 'Lord Funded le brinda total transparencia con datos de pago en tiempo real, ya sea a través de Payout Junction o Blockchain, garantizando velocidad, confianza y accesibilidad global.',
    payoutCTA: 'Obtén Financiamiento',
    payoutProcessed: 'Procesado en',
    payoutMinutes: 'Min',
    payoutHours: 'Hrs',
    payoutViewDetails: 'Ver Detalles',
  },
  ...
  fr: {
    ...
    // Le Voyage du Lord
    journeyTag: "Le Voyage du Lord",
    journeyTitle1: "Un Chemin Structuré Vers le",
    journeyTitle2: "Statut Financement d'Élite",
    journeySubtitle: "Un chemin structuré du défi au statut de financement d'élite.",
    journeyStep1Tag: "ÉTAPE 01", journeyStep1Title: "Acceptez le Défi", journeyStep1Desc: "Réussissez l'évaluation en respectant toutes les règles de risque.",
    journeyStep2Tag: "ÉTAPE 02", journeyStep2Title: "Gagnez votre Couronne", journeyStep2Desc: "Complétez la vérification et prouvez votre régularité de trading.",
    journeyStep3Tag: "ÉTAPE 03", journeyStep3Title: "Devenez Financé", journeyStep3Desc: "Recevez un compte financé et gagnez jusqu'à 90% de partage de profit.",
    journeyStep4Tag: "ÉTAPE 04", journeyStep4Title: "Dominez le Capital", journeyStep4Desc: "Faites grandir votre compte de 10k$ à 2M$ grâce au plan de croissance.",
    ...
    viewAll: 'Voir Tout', viewAllFAQs: 'Voir toutes les FAQ', learnMore: 'En Savoir Plus', seeRoadmap: 'Voir Feuille de Route', contactSupport: 'Contacter le Support',
    ...
    footerSubscribe: 'Abonnez-vous pour recevoir des mises à jour sur les limites de levier, promotions et nouvelles options de défis.',
    ...
    // Live Payouts
    payoutTitle1: 'Paiements Rendus Simples,', payoutTitle2: 'Sécurisés et Fluides',
    payoutDesc: 'Lord Funded vous offre une transparence totale avec des données de paiement en temps réel — que ce soit via Payout Junction ou la Blockchain, garantissant rapidité, confiance et accessibilité mondiale.',
    payoutCTA: 'Obtenez un Financement',
    payoutProcessed: 'Traité en',
    payoutMinutes: 'Min',
    payoutHours: 'H',
    payoutViewDetails: 'Voir les Détails',
  }
};
